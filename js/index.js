...
function animateBrands() {
  var brand1 = document.querySelectorAll('.brand1');
  var brand3 = document.querySelectorAll('.brand3');

  brand1.forEach(function(element) {
    element.classList.add('slideInFromLeftAnimation');
  });

  brand3.forEach(function(element) {
    element.classList.add('slideInFromRightAnimation');
  });
